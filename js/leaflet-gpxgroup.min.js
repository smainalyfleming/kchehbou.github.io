https: //unpkg.com/@raruto/leaflet-elevation@0.3.9/libs/leaflet-gpxgroup.min.jsL.Mixin.Selectable={includes:L.Mixin.Events,setSelected:function(s){var selected=!!s;if(this._selected!==selected){this._selected=selected;this.fire("selected")}},isSelected:function(){return!!this._selected}};
 L.Mixin.Selection = {
