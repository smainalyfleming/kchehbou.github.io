! function(t) {
 "function" == typeof define && define.amd ? define(t) : t()
      ...
      n = t.Marker.extend({
        ...
        _getIconSVG: function(t, e) {
         ...
         return {
          ...
          style = "'+e+'" / >
          <
          /svg>',w:n,h:n}},setStyle:function(e){t.Util.setOptions(this,e),this.createIcon()}}),s=n.extend({initialize:function(e,i,o){t.Util.setOptions(this,o),this._latlng=e,this._heading=i,this.createIcon()},setHeading:function(t){this._heading=t},_getIconSVG:function(t,e){var i=t.radius,o=t.width+t.weight,n=2*(i+t.depth+t.weight),s="M0,0 l"+t.width/
          2 + "," + t.depth + " l-" + o + ",0 z";
          return {
           ...
           "+n+'"
           style = "'+("
           transform: rotate("+this._heading+"
            deg)
           ")+'" >
           <
           path d = "'+s+'"
    ...
    L.Control.Pegman = L.Control.extend({
      ...
      options: {
       ...
       mouseMoveTracking: function(t) {
        ...
        t.pageY <
         e.old.y ? (e.direction.y = "top", this._updateClasses("mousemove-top")) : t.pageY > e.old.y && (e.direction.y = "bottom", this._updateClasses("mousemove-bottom")), t.pageX <
         e.old.x ? (e.direction.x = "left", this._updateClasses("mousemove-left")) : t.pageX > e.old.x && (e.direction.x = "right", this._updateClasses("mousemove-right")), e.old.x = t.pageX, e.old.y = t.pageY
       },
       ...
       _getTileCoords: function(t, e, i) {
        return {
         x: parseInt(Math.floor((e + 180) / 360 * (1 <
          <
          i))),
         y: parseInt(Math.floor((1 - Math.log(Math.tan(this._toRad(t)) + 1 / Math.cos(this._toRad(t))) / Math.PI) / 2 * (1 <
          <
          i))),
         z: i
        }
     ...
     function(t, e) {
      ...
      var e = t.Control.extend({
       ...
       _decideZoom: function(t) {
        ...
        return i > this.options.zoomLevelOffset && this._mainMap.getZoom() <
         this._miniMap.getMinZoom() - this.options.zoomLevelOffset ? this._miniMap.getZoom() > this._lastMiniMapZoom ? (e = this._mainMap.getZoom() + 1, this._miniMap.setZoom(this._miniMap.getZoom() - 1)) : e = this._mainMap.getZoom() : e = o, this._lastMiniMapZoom = this._miniMap.getZoom(), e
       },
      ...
      if ("function" == typeof define && define.amd) define(["leaflet"], t);
       ...
       return t.Control.Search = t.Control.extend({
        ...
        _createCancel: function(e, i) {
         ...
         return o.href = "#", o.title = e, o.style.display = "none", o.innerHTML = " <
          span > & otimes; < /span>",t.DomEvent.on(o,"click",t.DomEvent.stop,this).on(o,"click",this.cancel,this),o},_createButton:function(e,i){var o=t.DomUtil.create("a",i,this._container);return o.href="#",o.title=e,t.DomEvent.on(o,"click",t.DomEvent.stop,this).on(o,"click",this._handleSubmit,this).on(o,"focus",this.collapseDelayedStop,this).on(o,"blur",this.collapseDelayed,this),o},_createTooltip:function(e){var i=this,o=t.DomUtil.create("ul",e,this._container);return o.style.display="none",t.DomEvent.disableClickPropagation(o).on(o,"blur",this.collapseDelayed,this).on(o,"mousewheel",(function(e){i.collapseDelayedStop(),t.DomEvent.stopPropagation(e)}),this).on(o,"mouseover",(function(t){i.collapseDelayedStop()}),this),o},_createTip:function(e,i){var o;if(this.options.buildTip){if("string"==typeof(o=this.options.buildTip.call(this,e,i))){var n=t.DomUtil.create("div");n.innerHTML=o,o=n.firstChild}}else(o=t.DomUtil.create("li","")).innerHTML=e;return t.DomUtil.addClass(o,"search-tip"),o._text=e,this.options.tipAutoSubmit&&t.DomEvent.disableClickPropagation(o).on(o,"click",t.DomEvent.stop,this).on(o,"click",(function(t){this._input.value=e,this._handleAutoresize(),this._input.focus(),this._hideTooltip(),this._handleSubmit()}),this),o},_getUrl:function(t){return"function"==typeof this.options.url?this.options.url(t):this.options.url},_defaultFilterData:function(t,e){var i,o,n,s={};if(""===(t=t.replace(/ [.*+ ? ^ $ {}() | [\]\\] / g, ""))) return [];
       ...
       var t;
       this._input.style.maxWidth !== this._map._container.offsetWidth && (t = this._map._container.clientWidth, t -= 83, this._input.style.maxWidth = t.toString() + "px"), this.options.autoResize && this._container.offsetWidth + 20 <
        this._map._container.offsetWidth && (this._input.size = this._input.value.length <
         this._inputMinSize ? this._inputMinSize : this._input.value.length)
      }, _handleArrowSelect: function(e) {
       var o = this._tooltip.hasChildNodes() ? this._tooltip.childNodes : [];
       for (i = 0; i <
        o.length; i++) t.DomUtil.removeClass(o[i], "search-tip-select");
      ...
      animate: function() {
       if (this._circleLoc) {
        ...
        t._timerAnimLoc = setInterval((function() {
         o -= e += n += .5, t.setRadius(o), o <
          i && (clearInterval(t._timerAnimLoc), t.setRadius(i))
        }), 200)
       }
       return this
      }
      ...
      function i(t, e) {
       return function(t) {
        ...
        return e.bgcolor && (t.style.backgroundColor = e.bgcolor), e.width && (t.style.width = e.width + "px"), e.height && (t.style.height = e.height + "px"), e.style && Object.keys(e.style).forEach((function(i) {
          ...
          return function(t, e, i) {
           return Promise.resolve(t).then((function(t) {
            return t.setAttribute("xmlns", "http://www.w3.org/1999/xhtml"), (new XMLSerializer).serializeToString(t)
             ...
             y = "0"
             width = "100%"
             height = "100%" > '+t+"</foreignObject>"})).then((function(t){return' <
              svg
             xmlns = "http://www.w3.org/2000/svg"
             width = "'+e+'"
             height = "'+i+'" > '+t+" <
              /svg>"})).then((function(t){return"data:image/svg + xml;
             charset = utf - 8, "+t}))}(i,e.width||a.width(t),e.height||a.height(t))}))}function o(t,e){function o(t){var i=document.createElement("
             canvas ");if(i.width=e.width||a.width(t),i.height=e.height||a.height(t),e.bgcolor){var o=i.getContext("
             2 d ");o.fillStyle=e.bgcolor,o.fillRect(0,0,i.width,i.height)}return i}return i(t,e).then(a.makeImage).then(a.delay(100)).then((function(e){var i=o(t);return i.getContext("
             2 d ").drawImage(e,0,0),i}))}function n(t){return l.resolveAll().then((function(e){var i=document.createElement("
             style ");return t.appendChild(i),i.appendChild(document.createTextNode(e)),t}))}function s(t){return h.inlineAll(t).then((function(){return t}))}var a=function(){function t(t){var e=/\.([^\.\/]*?)$/g.exec(t);return e?e[1]:"
             "}function e(t,e){var i=window.getComputedStyle(t).getPropertyValue(e);return parseFloat(i.replace("
             px ","
             "))}return{escape:function(t){return t.replace(/([.*+?^${}()|\[\]\/\\])/g,"\\
             $1 ")},parseExtension:t,mimeType:function(e){var i=t(e).toLowerCase();return function(){var t="
             application / font - woff ",e="
             image / jpeg ";return{woff:t,woff2:t,ttf:"
             application / font - truetype ",eot:"
             application / vnd.ms - fontobject ",png:"
             image / png ",jpg:e,jpeg:e,gif:"
             image / gif ",tiff:"
             image / tiff ",svg:"
             image / svg + xml "}}()[i]||"
             "},dataAsUrl:function(t,e){return"
             data: "+e+";
             base64, "+t},isDataUrl:function(t){return-1!==t.search(/^(data:)/)},canvasToBlob:function(t){return t.toBlob?new Promise((function(e){t.toBlob(e)})):function(t){return new Promise((function(e){for(var i=window.atob(t.toDataURL().split(", ")[1]),o=i.length,n=new Uint8Array(o),s=0;s <
             o;
             s++) n[s] = i.charCodeAt(s); e(new Blob([n], {
             type: "image/png"
            }))
           }))
         }(t)
         ...
         var t = 0;
         return function() {
          return "u" + ("0000" + (Math.random() * Math.pow(36, 4) <
           <
           0).toString(36)).slice(-4) + t++
         }
        }(), delay: function(t) {
         return function(e) {
   ...
   L.Control.EasyPrint = L.Control.extend({
    ...
    _createSpinner: function(t, e, i) {
     ...
     n.epLoader {
      ...
      n color: #ffffff;\
      n font - size: 11 px;\
      n text - indent: -99999 em;\
      n margin: 55 px auto;\
      n position: relative;\
      n width: 10 em;\
      n height: 10 em;\
      n box - shadow: inset 0 0 0 1 em;\
      n - webkit - transform: translateZ(0);\
     ...
     n.epLoader: before {
      ...
      n border - radius: 0 10.2 em 10.2 em 0;\
      n top: -0.1 em;\
      n left: 5.1 em;\
      n - webkit - transform - origin: 0 px 5.1 em;\
      n transform - origin: 0 px 5.1 em;\
      n - webkit - animation: load2 2 s infinite ease;\
      n animation: load2 2 s infinite ease;\
      n
     }\
     n @ - webkit - keyframes load2 {
      \
      n 0 % {
       \
       n - webkit - transform: rotate(0 deg);\n transform: rotate(0 deg);\n
      }\
      n 100 % {
       \
       n - webkit - transform: rotate(360 deg);\n transform: rotate(360 deg);\n
      }\
      n
     }\
     n @keyframes load2 {
     ...
     n < /style>\n     <
      ...
      /body> <
      /html>'},_createNewWindow:function(t,e,i){return" <
      html >
      <
      head > \n <
      style > @media print {
     ...
     n.easyPrintHolder {
      \
      n margin - top: -31 px;\
      n margin - bottom: -5 px;\
      n margin - left: 30 px;\
      n padding - left: 0 px;\
      n display: none;\
      n
     }\
     n\ n.easyPrintSizeMode {
      \
      n display: inline - block;\
      n
     }\
     n.easyPrintHolder.easyPrintSizeMode a {
      \
      n border - radius: 0 px;\
      n
     }\
     n\ n.easyPrintHolder.easyPrintSizeMode: last - child a {
      \
      n border - top - right - radius: 2 px;\
      n border - bottom - right - radius: 2 px;\
      n margin - left: -1 px;\
      n
     }\
     n\ n.easyPrintPortrait: hover, .easyPrintLandscape: hover {
      \
      n background - color: #757570;\n      cursor: pointer;\n    }",document.body.appendChild(t)},_dataURItoBlob:function(t){for(var e= atob(t.split(",")[1]), i = t.split(",")[0].split(":")[1].split(";")[0], o = new ArrayBuffer(e.length), n = new DataView(o), s = 0;
      s
       <
       e.length;
      s++) n.setUint8(s, e.charCodeAt(s));
     return new Blob([o], {
      type: i
     })
    },
  ...
  const n = document.currentScript, s = "0.4.1+master.5716165f".split("+")[0].trim();
  var a = {
   ...
   var t = {
     ...
     streets: {
      ...
      options: {
       ...
       attribution: 'Map data: &copy; 
        ...
        <
        a href = "https://www.openstreetmap.org/copyright" > OpenStreetMap < /a> | Map style: &copy;  <
        a href = "http://www.thunderforest.com/" > Thunderforest < /a>'}},satellite:{name:"Satellite",url:"https:/ / server.arcgisonline.com / ArcGIS / rest / services / World_Imagery / MapServer / tile / {
         z
        }
       /{y}/ {
        x
       }
       ",options:{maxZoom:24,maxNativeZoom:18,attribution:'Map data: &copy;  <
       a href = "http://www.esri.com/" > Esri < /a> &mdash; Source: Esri, i-cubed, USDA, USGS, AEX, GeoEye, Getmapping, Aerogrid, IGN, IGP, UPR-EGP, and the GIS User Community'}},topo:{name:"Topo",url:"https:/ / {
        s
       ...
       /{x}/ {
        y
       }.png ",options:{maxZoom:24,maxNativeZoom:17,attribution:'Map data: &copy;  <
       ...
       ",querylang:"
       en - US ",detectUserLang:!0,jsonpParam:"
       json_callback ",propertyName:"
       display_name ",propertyLoc:["
       lat ","
       lon "],markerLocation:!0,autoType:!1,autoCollapse:!0,firstTipSubmit:!0,minLength:1,zoom:10,position:"
       bottomright "},printControl:{position:"
       bottomright ",hideControlContainer:!0,exportOnly:!0,sizeModes:["
       A4Portrait ","
       A4Landscape "]},resizerControl:{direction:"
       s "},disableDefaultUI:!1,plugins:[],_isMiniMap:!1};function e(){this.zoomControl&&this.zoomControl.remove(),this.fullscreenControl&&this.options.fullscreenControl&&!this.options.zoomControl&&this.fullscreenControl.remove(),this.searchControl&&this.options.searchControl&&this.searchControl.remove(),this.attributionControl&&this.attributionControl.remove()}function i(){for(let e in t)!0===this.options[e]||void 0===this.options[e]?this.options[e]=t[e]:"
       object "==typeof this.options[e]&&this.options[e]instanceof Array==!1&&(this.options[e]=p(t[e],this.options[e]));if(this.options.apiKeys&&(this.options.apiKeys.thunderforest&&(this.options.mapTypes.terrain.options.apikey=this.options.apiKeys.thunderforest),this.options.apiKeys.google&&(this.options.pegmanControl.apiKey=this.options.apiKeys.google)),this.options.mapTypes.terrain.options.apikey){var e=this.options.mapTypes.terrain.url;-1===e.indexOf("
       apikey = ")&&(this.options.mapTypes.terrain.url+=(-1===e.indexOf(" ? ")?" ? ":" & ")+"
       apikey = {
        apikey
       }
       ")}!1===this.options.mapTypeIds.includes(this.options.mapTypeId)&&this.options.mapTypeIds.length>0&&(this.options.mapTypeId=this.options.mapTypeIds[0]),this.options.searchControl&&this.options.searchControl.detectUserLang&&(this.options.searchControl.querylang=window.navigator.languages?window.navigator.languages[0]:window.navigator.userLanguage||window.navigator.language),this.options.searchControl&&this.options.searchControl.querylang&&(this.options.searchControl.url=this.options.searchControl.url.replace(" {
        querylang
       }
       ",this.options.searchControl.querylang)),!this.options.minimapControl||this.options.center||this.options.zoom||this.setView([0,0],0)}function o(){var t={},e={},i={};this.options.gestureHandling&&this.gestureHandling.enable();for(let t in this.options.mapTypeIds){var o=this.options.mapTypeIds[t];this.options.mapTypes[o]&&(i[this.options.mapTypes[o].name]=e[o]=new L.TileLayer(this.options.mapTypes[o].url,this.options.mapTypes[o].options),e[o].mapTypeId=o)}if(this._lastMapTypeId=this.options.mapTypeId,this._prevMapTypeId=this.options.mapTypeId,this.on("
       baselayerchange ",(function(t){t&&t.layer&&t.layer.mapTypeId&&(this._prevMapTypeId=this._lastMapTypeId,this._lastMapTypeId=t.layer.mapTypeId)})),this.on("
       baselayerchange ",(function(t){t&&t.layer&&t.layer.mapTypeId&&t.layer.bringToBack&&t.layer.bringToBack()})),this.options.layersControl&&(t.layers=new L.Control.Layers(i,null,this.options.layersControl),this.on("
       zoomend ",r,this)),this.options.attributionControl&&this.attributionControl&&(this.attributionControl.addTo(this),t.attribution=this.attributionControl,this.on("
       baselayerchange ",L.bind(n,this,this.attributionControl.options.prefix))),this.options.editInOSMControl&&(t.editInOSM=new L.Control.EditInOSM(this.options.editInOSMControl)),this.options.scaleControl&&(t.scale=new L.Control.Scale(this.options.scaleControl)),this.options.zoomControl&&this.zoomControl&&(this.zoomControl.setPosition(this.options.zoomControl.position),this.zoomControl.addTo(this),t.zoom=this.zoomControl),this.options.pegmanControl&&(t.pegman=new L.Control.Pegman(this.options.pegmanControl)),this.options.locateControl&&(t.locate=new L.Control.Locate(this.options.locateControl)),this.options.searchControl&&(t.search=this.searchControl=new L.Control.Search(this.options.searchControl)),this.options.printControl&&(t.print=new L.Control.EasyPrint(this.options.printControl)),this.options.loadingControl&&(t.loading=new L.Control.Loading(this.options.loadingControl)),this.options.fullscreenControl&&(t.fullscreen=this.fullscreenControl=new L.Control.FullScreen(this.options.fullscreenControl)),this.options.minimapControl){var l=this.options.minimapControl.mapOptions.mapTypeId,h=this.options.mapTypes[l];h&&((h=new L.TileLayer(h.url,h.options)).mapTypeId=l,t.minimap=new L.Control.MiniMap(h,this.options.minimapControl),t.minimap._mainMapBaseLayers=i)}this.options.resizerControl&&(t.resizer=new L.Control.Resizer(this.options.resizerControl));for(let e in t)t[e].addTo&&t[e].addTo(this);if(this.controls=t,this.whenReady((function(){if(this.fire("
       idle "),this.options.mapTypeId){let t=this.options.mapTypes[this.options.mapTypeId];if(t&&i[t.name]){this.options.layers=this.options.layers.filter(e=>e._leaflet_id!==i[t.name]._leaflet_id);let e=i[t.name];e.setZIndex?e.setZIndex(0):e.bringToBack&&e.bringToBack()}}}),this),this.options.mapTypeId){let t=this.options.mapTypes[this.options.mapTypeId];t&&i[t.name]&&this.options.layers.unshift(i[t.name])}if(this.options.plugins){if(!a.loader){var c=["
       leaflet - ui @ "+s+" / dist / leaflet - ui.css "];if(window.L){if(this.options.includeLeafletCSS&&L.version){let t="
       leaflet @ "+L.version+" / dist / leaflet.css ",e=!1;for(let i=0;i <
       document.styleSheets.length;i++) if (document.styleSheets[i].href && document.styleSheets[i].href.indexOf(t) > 0) {
       e = !0;
       break
      }
      e || c.unshift(t)
    ...
    else c.unshift("leaflet@1.3.4/dist/leaflet.css"),
    c.unshift("leaflet@1.3.4/dist/leaflet.js");a.loader = a.loadSyncScripts([c, this.options.plugins])
   }
   if (this._initHooks) {
    let t = this._initHooks.length;
    this.once("plugins_loaded", (function() {
     if (t <
      this._initHooks.length)
      for (var e = t, i = this._initHooks.length; e <
       i; e++) this._initHooks[e].call(this);
